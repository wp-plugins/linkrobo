...
Plugin URI: http://www.mypersonalgetaway.com/linkrobo
Donate link: https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=XBCF3P5894PA6
...
Stable tag: 1.0
Author URI: http://www.mypersonalgetaway.com
License: GPL2
*/
...
function linkbot_monitor_page() {
	...
	echo '<div class="wrap"><h2>Linkbot Monitor</h2><br/>';
	     echo '
<div>
<b>Menu:</b> Monitor | <a href="tools.php?page=linkbot">Settings</a> | <a href="http://www.mypersonalgetaway.com/linkrobo/">Support</a><br/><br/>
</div>
	     ';
	     echo '
<div style="width: 100%; border: #B4DB74 1px solid; background-color: #D6FD96; padding: 5px;">
<table><tr><td>
<form action="https://www.paypal.com/cgi-bin/webscr" method="post">
<input type="hidden" name="cmd" value="_s-xclick">
<input type="hidden" name="hosted_button_id" value="XBCF3P5894PA6">
<input type="image" src="https://www.paypalobjects.com/en_US/i/btn/btn_donateCC_LG.gif" border="0" name="submit" alt="PayPal - The safer, easier way to pay online!">
<img alt="" border="0" src="https://www.paypalobjects.com/en_US/i/scr/pixel.gif" width="1" height="1">
</form>
</td>
<td>
Please donate to keep this plugin FREE.<br/>
If you find this plugin useful to you, please consider making a small donation to help contribute to my time invested and to further development.<br/>
...
<thead>
	...
	if ($sites) {
		foreach ($sites as $site) {
			...
			if ($acceptors)
				foreach ($acceptors as $acceptor) if ($acceptor>0) $posts_html_arr[] = "<a href='".get_permalink($acceptor)."'>".get_the_title($acceptor)."</a>";
...
function linkbot_settings_page() {
	     ...
	     echo '
<div>
<b>Menu:</b> <a href="tools.php?page=linkbot">Monitor</a> | Settings | <a href="http://www.mypersonalgetaway.com/linkrobo/">Support</a><br/><br/>
</div>
	     ';
	     echo '
<div style="width: 550px; border: #B4DB74 1px solid; background-color: #D6FD96; padding: 10px;">
<h3>Donate</h3>
...
function linkrobo_plugin_add_settings($links, $file) {
	if ( $file == basename( dirname( __FILE__ ) ).'/'.basename( __FILE__ ) ) {		$links[] = '<a href="tools.php?page=linkbot">' . __('Monitor') . '</a>';
		...
		$links[] = '<a href="http://www.mypersonalgetaway.com/linkrobo/">' . __('Support') . '</a>';
		$links[] = '<a href="https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=XBCF3P5894PA6">' . __('Donate') . '</a>';
	}
...
function linkrobo_keyword2link_filter($content) {	global $wpdb, $post;
	...
	$id = intval($post->ID);
	$sql = "SELECT * FROM {$wpdb->prefix}tb_links WHERE posts LIKE '$id' OR posts LIKE '%,$id' OR posts LIKE '$id,%'";
	...
	if ($links) {		foreach ($links as $link) {			$query = $link['query'];
			...
			$try = 0;			while(preg_match($query_pattern, $content)) {				$try++;
				...
				if ($good_replacement) {					$content = preg_replace($query_pattern, "\\1<a href=\"{$url['url']}\">\\2</a>\\3", $content, 1);
					break;
					}
				if ($try>=15) break;			}
		}	}	return $content;}
